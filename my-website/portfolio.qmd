...
For this assignment, I had to deconstruct a journal article, rerun their case study selection on a different chosen geography, and complete a descriptive analysis on this new area of interest.

I received a peer-reviewed journal article with a few different geographies/scales to choose from.I then deconstructed their variables (e.g., what population thresholds do they classify as high-density urban), taking those measures and applying them to a metropolitan area of my choice. On the newly defined landscape, I needed descriptive analyses to describe the demographic characteristics of that place. 
...
For a lab, I had to download various 2020 Census data and map them.

Figure 1 presents median income by county in California. It shows that the

Figure 1: Median Income by County

![](images/clipboard-2449182646.png)

Figure 2 shows the distribution of four racial categories across Conoma County.

Figure 2: Racial Distribution

![](images/clipboard-294041286.png)

Figure 3 presents the count of people under 18 across Sonoma County. The north, west and east parts of the county are more rural and generally have fewer young people. What could improve this map would be a presentation of the percent of the young people of the total population within the area.

Figure 3: Distribution of and County of people under 18

![\
](images/clipboard-3916933587.png)

## Exploratory Data Analysis

This lab was the introduction to the R Studio environment and basic visualizations.

Figure 1 shows a population pyramid for the California by gender.

Figure 1: Population Pyramid

![](images/clipboard-3372825492.png)

Figure 2 shows the median income range per county in California. General trends show that more urbanized counties have higher incomes in tighter ranges and rural counties have lower incomes. However, there are two counties, Alpine and Mono which hug the east side of the Sierra Nevadas that present large ranges in variation.

Figure 2: Median Houshold Income by County

![](images/clipboard-3546555487.png)

Figure 3 compares the cities with the highest proportion of commuters that use public transit. New York leads with about 33% of its commuters taking public transit followed by San Francisco at about 18%.

Figure 3: Proportion of Public Transportation Commute

![](images/clipboard-3068064416.png)
